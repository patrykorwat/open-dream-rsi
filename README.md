...
![Decoy-trap policy benchmark: greedy vs epsilon-greedy vs replay-gated LLM-written policies vs curated knowledge base](docs/screenshots/odr_policy_bench.png)
